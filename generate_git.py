                ...
                for ref_times in ref_times_list:
                    for boundary_type in boundary_type_list:
                        ...
                        for early_stop_type in early_stop_type_list:
                            ...
                            train_method = 'MLP_{0}_{1}'.format(sample_method, early_stop_type)
                            test_file_path = 'git add ./test_{0}/result_{1}_{2}/record_{3}/\n'.format(dataset, train_method, test_method, record_index)

                            command_list.append(test_file_path)
        command_list.append('\n')
    command_list.append('\n\n')
...
with open('git_add_commond.sh', 'w') as fsh:
...
#         fsh.write('#PBS -m ae\n')
#         fsh.write('#PBS -j oe\n\n')
#         fsh.write('#PBS -o /srv/scratch/z5102138/test_ijcai_vnoise/\n')
#         fsh.write('source ~/anaconda3/etc/profile.d/conda.sh\n')
#         fsh.write('conda activate py36\n\n\n')
#         fsh.write('cd /srv/scratch/z5102138/test_ijcai_vnoise\n')
